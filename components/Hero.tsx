  ...
  return (
    <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 px-6 max-w-7xl mx-auto flex flex-col items-center text-center z-10">
      ...
      <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto animate-fade-in-up" style={{ animationDelay: '300ms' }}>
        <button className="px-8 py-4 rounded-xl bg-white text-obsidian font-bold text-base hover:bg-gray-200 transition-all flex items-center justify-center gap-2 shadow-lg shadow-white/10 group">
          {content.primaryBtn}
          <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
        </button>
        
        <button className="px-8 py-4 rounded-xl glass-panel text-white font-semibold text-base hover:bg-white/5 transition-all flex items-center justify-center gap-2 group">
